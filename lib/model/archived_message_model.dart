...
//
//     final archivedModel = archivedModelFromJson(jsonString);


ArchivedModel archivedModelFromJson(String str) => ArchivedModel.fromJson(json.decode(str));

String archivedModelToJson(ArchivedModel data) => json.encode(data.toJson());
...
class ArchivedModel {
    ...
    factory ArchivedModel.fromJson(Map<String, dynamic> json) => ArchivedModel(
