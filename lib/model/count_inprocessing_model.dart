...
//
//     final countInprocessingModel = countInprocessingModelFromJson(jsonString);

// ignore_for_file: prefer_if_null_operators

import 'dart:convert';

CountInprocessingModel countInprocessingModelFromJson(String str) => CountInprocessingModel.fromJson(json.decode(str));

String countInprocessingModelToJson(CountInprocessingModel data) => json.encode(data.toJson());

class CountInprocessingModel {
    CountInprocessingModel({
        this.message,
        this.count,
        this.payload,
    });
    ...
    factory CountInprocessingModel.fromJson(Map<String, dynamic> json) => CountInprocessingModel(
