...
DetailInprocessModel detailInprocessModelFromJson(String str) => DetailInprocessModel.fromJson(json.decode(str));

String detailInprocessModelToJson(DetailInprocessModel data) => json.encode(data.toJson());

class DetailInprocessModel {
    DetailInprocessModel({
        this.message,
        this.payload,
    });
    ...
    factory DetailInprocessModel.fromJson(Map<String, dynamic> json) => DetailInprocessModel(
